...
def _transform_analysis_result(analysis_result) -> Dict[str, Any]:
    ...
    Args:
        analysis_result: PageAnalysisResult object
    ...
    return {
        ...
        "score_ux": analysis_result.ux.score,
        "score_performance": analysis_result.performance.score,
        "score_seo": analysis_result.seo.score,
        "ux_impact_score": analysis_result.ux.impact_score,
        "performance_impact_score": analysis_result.performance.impact_score,
        "seo_impact_score": analysis_result.seo.impact_score,
    }
